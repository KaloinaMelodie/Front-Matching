...
export default function ExperiencesProTimeLine({ experiences_professionnelles }) {
  ...
  const sortedData = sortByStartDate(
        ...
        return (
          <TimelineItem key={index}>
            ...
            <TimelineBody className="pb-8">
              ...
              >
                {item.nom_de_l_entreprise} - {startMonth}/{startYear} à{" "}
              ...
              >
                <ul>
                  {item.missions_realisees.map((mission, idx) => (
